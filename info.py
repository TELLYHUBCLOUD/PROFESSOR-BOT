...
# PyroClient Setup 
#£API_ID = int(environ['23241238'])
API_ID = int(environ.get('23241238', 'default_value'))
API_HASH = environ['e6ff6e3068dbea75500865ac49c3608f']
BOT_TOKEN = environ['6761188489:AAHIZRX5Fgy_sLuzSh-q6IwLu1sukubW6UU']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001984679138').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5056925533').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://okboss:okboss@cluster0.ca8ebh1.mongodb.net/?retryWrites=true&w=majority")
